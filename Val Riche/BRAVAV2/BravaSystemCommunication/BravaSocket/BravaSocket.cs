    ...
    public class BravaSocket
    {
        ...
        public void OpenConnection()
        {
            ...
            try
            {
                ...
                reqClient.ReceiveTimeout = 100;   // 10000
                reqClient.SendTimeout = 100;      // 10000
        ...
        public void DoTransaction()
        {
                ...
                {
                    this.Transaction.State = BravaTransaction.TransactionState.Open;
                    ...
                    if (Connection.rqStream.DataAvailable)
                    {
                        ...
                        if (bytesBuffer[0] == (int)BravaCodes.ProtocolStatus.ACK)
                        {
                            ...
                            #region Todo: Removed this, we dont care for ore data, only result
