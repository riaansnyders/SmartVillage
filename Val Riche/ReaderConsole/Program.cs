                    ...
                    LogEvent("Session started for meter with ip: " + ipAddress, writeToLog);
                        ...
                        if (socket.Connected)
                        {
                            ...
                            if (handShake.Contains("/GEC"))
                            {
                                ...
                                //<SOH>W1<STX>605001(1A2A4A00)<ETX><DC2>

                                //<SOH>W1<STX>551001(0100)<ETX>g
                                ...
                                //byte[] bytePhaseOneRequest = new byte[256];

                                //System.Threading.Thread.Sleep(500);

                                //socket.Receive(bytePhaseOneRequest);

                                //string phaseOneResult = Encoding.ASCII.GetString(bytePhaseOneRequest);

                                //if (!phaseOneResult.Contains("ERR"))
                                //{
                                  //  LogEvent("Phase 1 reading received", writeToLog);

                                    //SAMPLE RESULT: <STX>(9DAD4D0D)<ETX>~
                                    //string[] voltageArray = phaseOneResult.Split("(".ToCharArray());
                                    ...
                                    //long currentUsage = Convert.ToInt64(volts, 16);
                                    //decimal meterVoltage = Convert.ToDecimal(currentUsage);

                                    //LogEvent("Phase 1 reading: " + meterVoltage.ToString(), writeToLog);

                                    //meterReadings.Add(meterVoltage);
                                //}
                                //else
                                //{
                                ...
                                //socket.Send(Encoding.ASCII.GetBytes("W1"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x02"));
                                //socket.Send(Encoding.ASCII.GetBytes("605001(1B2B4A00)"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x03"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x12"));
                               ...
                               // string phaseTwoResult = Encoding.ASCII.GetString(bytePhaseTwoRequest);
                                ...
                                //if (!phaseTwoResult.Contains("ERR"))
                                //{
                                //    LogEvent("Phase 2 reading received", writeToLog);

                                //    //SAMPLE RESULT: <STX>(9DAD4D0D)<ETX>~
                                //    string[] voltageArray = phaseTwoResult.Split("(".ToCharArray());
                                //    string voltage = voltageArray[1].ToString();
                                //    string[] cleanVoltageArr = voltage.Split(")".ToCharArray());
                                //    string volts = cleanVoltageArr[0].ToString();
                                ...
                                //    LogEvent("Phase 2 reading: " + meterVoltage.ToString(), writeToLog);
                                ...
                                //socket.Send(Encoding.ASCII.GetBytes("W1"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x02"));
                                //socket.Send(Encoding.ASCII.GetBytes("605001(1C2C4A00)"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x03"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x12"));
                                ...
                                //socket.Send(Encoding.ASCII.GetBytes("R1"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x02"));
                                //socket.Send(Encoding.ASCII.GetBytes("605003(01)"));
                                //socket.Send(Encoding.ASCII.GetBytes("\x03"));
                                //socket.Send(Encoding.ASCII.GetBytes("e"));

                                //byte[] bytePhaseThreeRequest = new byte[256];

                                //System.Threading.Thread.Sleep(500);

                                //socket.Receive(bytePhaseThreeRequest);

                                //string phaseThreeResult = Encoding.ASCII.GetString(bytePhaseThreeRequest);

                                //if (!phaseThreeResult.Contains("ERR"))
                                //{
                                  //  LogEvent("Phase 3 reading received", writeToLog);

                                    //SAMPLE RESULT: <STX>(9DAD4D0D)<ETX>~
                                    //string[] voltageArray = phaseThreeResult.Split("(".ToCharArray());
                                    //string voltage = voltageArray[1].ToString();
                                    //string[] cleanVoltageArr = voltage.Split(")".ToCharArray());
                                    //string volts = cleanVoltageArr[0].ToString();
                                    ...
                                    //LogEvent("Phase 3 reading: " + meterVoltage.ToString(), writeToLog);
                               ...
                               // <SOH>R1<STX>606001(1C)<ETX><DLE>
                                ...
                                if (!readingResult.Contains("ERR"))
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(currentUsage))
                                    {
                                        ...
                                        LogEvent("Meter Reading: " + currentUsage, writeToLog);
                                ...
                                socket.Send(Encoding.ASCII.GetBytes("\x01"));
                                socket.Send(Encoding.ASCII.GetBytes("R2"));
                                socket.Send(Encoding.ASCII.GetBytes("\x02"));
                                socket.Send(Encoding.ASCII.GetBytes("605001(01)"));
                                socket.Send(Encoding.ASCII.GetBytes("\x03"));
                                socket.Send(Encoding.ASCII.GetBytes("e"));
